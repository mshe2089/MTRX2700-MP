...
//The "servo_controller" is responsble for intiallising the parameters for the PWM singnals of 6 and 7 which concantenated 
//and responsible for controlling.The horizontal sweeping servo. Also this function is responsible for intiallising the 
//parameters needed for the cocantenated PWM signals of 4 and 5 which is responsible for controlling the veterical sweeping servo
